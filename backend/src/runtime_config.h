...
struct RuntimeConfig {
  ...
  std::string licenseInline;
  std::string licenseFile;
  std::string licenseCrlFile;
};
...
inline void apply_runtime_config(AppContext &ctx, const RuntimeConfig &config) {
  ...
  ctx.license_inline = config.licenseInline;
  ctx.license_file_path = config.licenseFile;
  ctx.license_crl_path = config.licenseCrlFile;
}
