...
// Defined in license.cc. Returns true if the request targets a premium prefix
// that the current license does not entitle, in which case it has already set a
// 402 response and the handler must be skipped.
namespace license {
